...
class Cep 
{
    ...
    public $key;
    public $data;
    //base local de cep caso possua (est� dispon�vel para venda no phpstaff.com.br)
    ...
    public function __construct()
    {
        ...
        {
            die( 'A fun��o Curl n�o est� dispon�vel em seu PHP.' );
        }
    ...
    public function teste()
    {
        ...
        echo '<br>';
        echo $this->_getEndereco( array( "endereco" => "Av Brasil,Boqueir�o,Praia Grande,SP" ) );
    }
