 ...
 public function notificarAdmin()
    {
        ...
        $body .= '<tr style="background: #30ADE7;"><td style="color:#fff"><strong>Cliente:</strong> </td><td style="color:#fff">' . $this->cliente_fullnome . '</td></tr>';
        $body .= '<tr style="background: #fff;"><td><strong>Email:</strong> </td><td style="color:#fff">' . $this->cliente_email . '</td></tr>';
        ...
        if ( $this->pedido_cupom_desconto != 0 )
        {
            ...
            $body .= '<tr style="background: #fff;"><td><strong>Subtotal:</strong> </td><td>' . $this->_money( $this->pedido_total_produto  - $this->pedido_cupom_desconto) . '</td></tr>';
            $body .= '<tr style="background: #30ADE7;"><td style="color:#fff"><strong>Frete:</strong> </td><td style="color:#fff">' . $this->_money( $this->valor_frete ) . '</td></tr>';
            $body .= '<tr style="background: #fff;"><td><strong>Valor Total:</strong> </td><td>' . $this->_money( ($this->pedido_total_produto  - $this->pedido_cupom_desconto) + $this->valor_frete ) . '</td></tr>';
        }
        else
        {
            $body .= '<tr style="background: #30ADE7;"><td style="color:#fff"><strong>Frete:</strong> </td><td style="color:#fff">' . $this->_money( $this->valor_frete ) . '</td></tr>';
            $body .= '<tr style="background: #fff;"><td><strong>Total a Pagar:</strong> </td><td>' . $this->_money( ($this->pedido_total_produto  - $this->pedido_cupom_desconto) + $this->valor_frete ) . " - $this->prazo_frete " . '</td></tr>';
        }
        $body .= '</table>';
        $body .= '</body></html>';
        $n = array(
